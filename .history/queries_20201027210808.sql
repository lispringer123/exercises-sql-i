...
SELECT * FROM invoices WHERE billing_country = 'USA' ORDER BY total ASC LIMIT 10;


-- The 10 most expensive invoices from outside the US
SELECT * FROM invoices WHERE NOT billing_country = 'USA' ORDER BY total DESC LIMIT 10;
SELECT * FROM invoices WHERE billing_country != 'USA' ORDER BY total DESC LIMIT 10;
